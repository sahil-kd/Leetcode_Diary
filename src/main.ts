...
const desktop_path: string = path.join(os.homedir(), "Desktop");
...
console.log(
	"Free memory available to node processes = ",
	node_free_mem * Math.pow(10, -6),
	" MB"
);
console.log(
	"Total memory available to node processes = ",
	node_total_mem * Math.pow(10, -6),
	" MB"
);
